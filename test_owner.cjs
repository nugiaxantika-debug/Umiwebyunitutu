...
let set = new Set();
set.add(normalizeJid("62812345678@s.whatsapp.net"));
console.log(set.has(normalizeJid("62812345678")));
console.log(set.has(normalizeJid("0812345678")));
console.log(set.has(normalizeJid("62812345678:1@s.whatsapp.net")));
console.log(set.has(normalizeJid("62812345678@s.whatsapp.net")));
